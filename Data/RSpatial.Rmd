...
# setwd() postavlja novi direktorij u kojem se nalaze naši podaci
# Ovdje je potrebno promijeniti put prema lokaciji vaših datoteka
setwd("C:/Users/dbecic/OneDrive - Grad Zagreb/Desktop/R Projects/RDemo_KlubR/Data")


# 1. Učitavanje prostornih podataka
...
for (file in shp_files) {
  # Uklanja ekstenziju .shp iz Kljuca datoteke kako bi se dobilo ime objekta
  object_name <- tools::file_path_sans_ext(file)
  
  # Učitava shapefile koristeći st_read() funkciju iz sf biblioteke
  # assign() dinamički kreira objekt s imenom temeljenim na Kljucu datoteke
  assign(object_name, st_read(file))
}

# 2. Pregled učitanih prostornih podataka
# Prikazuje kompletne podatke (ovisno o veličini objekta, prikazuje samo dio podataka)
print(Katastar)

# summary() daje osnovne informacije o objektu, uključujući tipove podataka i osnovne statistike
summary(Katastar)

# names() prikazuje imena svih stupaca (atributa) unutar prostornog sloja
names(Katastar)
